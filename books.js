...
const predefinedBooks = [
    ...
    { id: "system-2", title: "1984", author: "George Orwell", content: "A dystopian social science fiction novel by English author George Orwell. Published on 8 June 1949 by Secker & Warburg, it is set in Airstrip One (formerly Great Britain), a province of the superstate Oceania, where the Party maintains power through surveillance, propaganda, and repression.", imageUrl: "1984.png", creatorId: "system", genre: "science fiction" },
    { id: "system-3", title: "Pride and Prejudice", author: "Jane Austen", content: "A romantic novel of manners written by Jane Austen in 1813. The story follows the main character, Elizabeth Bennet, as she deals with issues of manners, upbringing, morality, absence, and marriage in the society of the landed gentry of the British Regency.", imageUrl: "PRIDE AND PREJUDICE.png", creatorId: "system", genre: "romance" },
    { id: "system-4", title: "To Kill a Mockingbird", author: "Harper Lee", content: "A novel by Harper Lee published in 1960. It was immediately successful, winning the Pulitzer Prize, and has become a classic of modern American literature.", imageUrl: "to kill a mockingbird.png", creatorId: "system", genre: "fiction" },
    { id: "system-5", title: "The Great Gatsby", author: "F. Scott Fitzgerald", content: "A novel illustrating the Jazz Age.", imageUrl: "the great gatsby.png", creatorId: "system", genre: "fiction" },
    { id: "system-6", title: "Dune", author: "Frank Herbert", content: "A science fiction novel set in the distant future amidst a feudal interstellar society in which various noble houses control planetary fiefs.", imageUrl: "dune.png", creatorId: "system", genre: "science fiction" },
    { id: "system-7", title: "Murder on the Orient Express", author: "Agatha Christie", content: "A detective novel by the English writer Agatha Christie, featuring the Belgian detective Hercule Poirot.", imageUrl: "murder.png", creatorId: "system", genre: "mystery" },
    { id: "system-8", title: "The Silent Patient", author: "Alex Michaelides", content: "A shocking psychological thriller about a woman's act of violence against her husband—and the psychotherapist obsessed with uncovering what happened.", imageUrl: "silent.png", creatorId: "system", genre: "thriller" },
    { id: "system-9", title: "Educated", author: "Tara Westover", content: "An American memoir by Tara Westover, published in February 2018. It tells the story of her journey from growing up in a fundamentalist Mormon household in rural Idaho to earning a PhD at Cambridge University.", imageUrl: "educated.png", creatorId: "system", genre: "biography" },
    { id: "system-10", title: "Sapiens: A Brief History of Humankind", author: "Yuval Noah Harari", content: "A book by Yuval Noah Harari, first published in Hebrew in 2011 and in English in 2014. It surveys the history of humankind from the Stone Age up to the twenty-first century.", imageUrl: "sapiens.png", creatorId: "system", genre: "history" },
    { id: "system-11", title: "Atomic Habits", author: "James Clear", content: "An American self-help book by James Clear. It offers a practical framework for improving every day.", imageUrl: "atomic.png", creatorId: "system", genre: "self-help" },
    { id: "system-12", title: "The Alchemist", author: "Paulo Coelho", content: "An allegorical novel by Brazilian author Paulo Coelho, first published in 1988. It's about a young shepherd who journeys from his homeland in Spain to the Egyptian desert in search of a treasure.", imageUrl: "the alchemist.png", creatorId: "system", genre: "fiction" },
    { id: "system-13", title: "The Lord of the Rings", author: "J.R.R. Tolkien", content: "An epic high-fantasy novel. Follows Frodo Baggins on a quest to destroy the One Ring.", imageUrl: "lord.png", creatorId: "system", genre: "fantasy" },
    { id: "system-14", title: "Foundation", author: "Isaac Asimov", content: "A science fiction novel that is the first of the Foundation series. Chronicles the decline of the Galactic Empire.", imageUrl: "foundation.png", creatorId: "system", genre: "science fiction" },
    { id: "system-15", title: "The Da Vinci Code", author: "Dan Brown", content: "A mystery thriller novel. Follows symbologist Robert Langdon and cryptologist Sophie Neveu as they investigate a murder in Paris.", imageUrl: "da vinci.png", creatorId: "system", genre: "mystery" },
    { id: "system-16", title: "The Hitchhiker's Guide to the Galaxy", author: "Douglas Adams", content: "A comedy science fiction series created by Douglas Adams. Follows the adventures of Arthur Dent after the destruction of Earth.", imageUrl: "adams.png", creatorId: "system", genre: "science fiction" },
    { id: "system-17", title: "Sense and Sensibility", author: "Jane Austen", content: "A novel by Jane Austen. Explores the Dashwood sisters' experiences with love, romance, and heartbreak.", imageUrl: "sense.png", creatorId: "system", genre: "romance" },
    { id: "system-18", title: "Crime and Punishment", author: "Fyodor Dostoevsky", content: "A novel by Fyodor Dostoevsky. Focuses on the mental anguish and moral dilemmas of Rodion Raskolnikov, a former student.", imageUrl: "crime.png", creatorId: "system", genre: "fiction" },
    { id: "system-19", title: "The Picture of Dorian Gray", author: "Oscar Wilde", content: "A philosophical novel by Oscar Wilde. Tells of a young man whose portrait ages while he remains young and beautiful.", imageUrl: "dorian.png", creatorId: "system", genre: "fiction" },
    { id: "system-20", title: "Frankenstein", author: "Mary Shelley", content: "A novel by Mary Shelley. Deals with themes of ambition, creation, and responsibility.", imageUrl: "frank.png", creatorId: "system", genre: "horror" },
    { id: "system-21", title: "Dracula", author: "Bram Stoker", content: "A Gothic horror novel by Irish author Bram Stoker. Introduces the character of Count Dracula.", imageUrl: "dracula.png", creatorId: "system", genre: "horror" },
    { id: "system-22", title: "The Odyssey", author: "Homer", content: "One of two major ancient Greek epic poems attributed to Homer. Recounts the journey of Odysseus back to Ithaca.", imageUrl: "odyssey.png", creatorId: "system", genre: "classic" },
    { id: "system-23", title: "Don Quixote", author: "Miguel de Cervantes", content: "A Spanish novel by Miguel de Cervantes. Tells the story of a hidalgo who reads too many chivalric romances.", imageUrl: "don quijote.png", creatorId: "system", genre: "classic" },
    { id: "system-24", title: "Moby Dick", author: "Herman Melville", content: "A novel by Herman Melville. Explores the obsessive quest of Captain Ahab for the white whale, Moby Dick.", imageUrl: "moby.png", creatorId: "system", genre: "classic" },
    { id: "system-25", title: "War and Peace", author: "Leo Tolstoy", content: "A novel by the Russian author Leo Tolstoy. Chronicles the history of the French invasion of Russia.", imageUrl: "war and peace.png", creatorId: "system", genre: "classic" },
